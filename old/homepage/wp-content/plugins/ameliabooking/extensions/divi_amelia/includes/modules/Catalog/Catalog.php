...
class DIVI_Catalog extends ET_Builder_Module
{
    ...
    public function init()
    {
        ...
        $this->categories['0'] = BackendStrings::getWordPressStrings()['select_category'];
        foreach ($data['categories'] as $category) {
            $this->categories[$category['id']] = $category['name'] . ' (id: ' . $category['id'] . ')';
        }

        $this->services['0'] = BackendStrings::getWordPressStrings()['select_service'];
        ...
        $this->packages['0'] = BackendStrings::getWordPressStrings()['select_package'];
