<template>
  <div class="am-wrap">
    <transition name="fade">
      <div v-if="trafftBannerVisible && $root.settings.activation.enableTrafftBanner" class="am-trafft-banner">
  ...
  export default {
    ...
    methods: {
      removeBanner () {
        ...
        this.$http.post(`${this.$root.getAjaxUrl}/settings`, {activation: {enableTrafftBanner: !this.trafftBannerVisible}})
          .then(response => {
          })
          .catch(e => {
          })
