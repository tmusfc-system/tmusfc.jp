    ...
    return(
      ...
      <h1 className="text-3xl font-bold mb-8">活動概要</h1>
        ...
        <div className="space-y-8">
          ...
          <div className="border-l-2 border-slate-200 pl-6 pb-6">
            <h3 className="font-semibold text-lg">活動の概略</h3>
            <p className="text-slate-600 mt-1">現在行っている活動は大きく分けて、近隣の小学校や科学館などへの「出張実験」と、大学祭期間中の「体験！化学実験」です。子ども達に大人気なスライム作り、人工いくら作りなど、様々な化学実験を行っています。詳しくはページ上部の「出張実験」「体験!化学実験」からご覧ください。</p>
        </div>
        </div>
         </div>
    )
